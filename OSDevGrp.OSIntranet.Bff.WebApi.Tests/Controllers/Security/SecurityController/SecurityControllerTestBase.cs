...
public abstract class SecurityControllerTestBase<TQueryFeatureResponse> where TQueryFeatureResponse : class, IResponse
{
    ...
    protected static WebApi.Controllers.Security.SecurityController CreateSut(Mock<IProblemDetailsFactory> problemDetailsFactoryMock, Mock<ITrustedDomainResolver> trustedDomainResolverMock, Mock<ISecurityContextProvider> securityContextProviderMock, Mock<IAntiforgery> antiforgeryMock, Fixture fixture, HttpContext? httpContext = null, ProblemDetails? problemDetails = null, bool isTrustedDomain = true, IFormatProvider? formatProvider = null, ISecurityContext? securityContext = null)
    {
        ...
        return new WebApi.Controllers.Security.SecurityController(problemDetailsFactoryMock.Object, trustedDomainResolverMock.Object, formatProvider ?? CultureInfo.InvariantCulture, securityContextProviderMock.Object, antiforgeryMock.Object)
        {
