...
namespace OSDevGrp.OSIntranet.Domain.Tests.Accounting.AccountCollection
{
    ...
    public class ValuesAtStatusDateTests
    {
        ...
        [Test]
        [Category("UnitTest")]
        public void ValuesAtStatusDate_WhenCalculateAsyncHasNotBeenCalled_ReturnsAccountCollectionValuesWhereAssetsIsEqualToZero()
        {
            IAccountCollection sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void ValuesAtStatusDate_WhenCalculateAsyncHasNotBeenCalled_ReturnsAccountCollectionValuesWhereLiabilitiesIsEqualToZero()
        {
            IAccountCollection sut = CreateSut();
