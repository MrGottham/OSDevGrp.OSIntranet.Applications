...
{
    [TestFixture]
    public class CreateBookGenreWithoutModelTests
    {
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateBookGenre_WhenCalled_ReturnsNotNull()
        {
            Controller sut = CreateSut();

            IActionResult result = sut.CreateBookGenre();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateBookGenre_WhenCalled_ReturnsViewResult()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateBookGenre_WhenCalled_ReturnsViewResultWhereViewNameIsNotNull()
        {
            Controller sut = CreateSut();

            ViewResult result = (ViewResult)sut.CreateBookGenre();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateBookGenre_WhenCalled_ReturnsViewResultWhereViewNameIsNotEmpty()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateBookGenre_WhenCalled_ReturnsViewResultWhereViewNameIsEqualToCreateGenericCategory()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateBookGenre_WhenCalled_ReturnsViewResultWhereModelIsNotNull()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateBookGenre_WhenCalled_ReturnsViewResultWhereModelIsGenericCategoryViewModel()
        {
            Controller sut = CreateSut();
            ...
            Assert.That(genericCategoryViewModel.Header, Is.EqualTo("Opret litterær genre"));
            ...
            Assert.That(genericCategoryViewModel.SubmitAction, Is.EqualTo("CreateBookGenre"));
