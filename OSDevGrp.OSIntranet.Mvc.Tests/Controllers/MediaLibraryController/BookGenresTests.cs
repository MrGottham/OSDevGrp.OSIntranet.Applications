...
namespace OSDevGrp.OSIntranet.Mvc.Tests.Controllers.MediaLibraryController
{
    ...
    public class BookGenresTests
	{
        ...
        [TestCase(true)]
        [TestCase(false)]
        public async Task BookGenres_WhenCalled_ReturnsViewResultWhereModelIsGenericCategoryCollectionViewModel(bool hasBookGenreCollection)
        {
            Controller sut = CreateSut(hasBookGenreCollection);
        ...
        private Controller CreateSut(bool hasBookGenreCollection = true, IEnumerable<IBookGenre> bookGenreCollection = null)
        {
