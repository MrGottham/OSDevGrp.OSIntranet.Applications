...
{
    [TestFixture]
    public class CreateMediaTypeWithoutModelTests
    {
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMediaType_WhenCalled_ReturnsNotNull()
        {
            Controller sut = CreateSut();

            IActionResult result = sut.CreateMediaType();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMediaType_WhenCalled_ReturnsViewResult()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMediaType_WhenCalled_ReturnsViewResultWhereViewNameIsNotNull()
        {
            Controller sut = CreateSut();

            ViewResult result = (ViewResult)sut.CreateMediaType();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMediaType_WhenCalled_ReturnsViewResultWhereViewNameIsNotEmpty()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMediaType_WhenCalled_ReturnsViewResultWhereViewNameIsEqualToCreateGenericCategory()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMediaType_WhenCalled_ReturnsViewResultWhereModelIsNotNull()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMediaType_WhenCalled_ReturnsViewResultWhereModelIsGenericCategoryViewModel()
        {
            Controller sut = CreateSut();
            ...
            Assert.That(genericCategoryViewModel.Header, Is.EqualTo("Opret medietype"));
            ...
            Assert.That(genericCategoryViewModel.SubmitAction, Is.EqualTo("CreateMediaType"));
