...
{
    [TestFixture]
    public class CreateMusicGenreWithoutModelTests
    {
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMusicGenre_WhenCalled_ReturnsNotNull()
        {
            Controller sut = CreateSut();

            IActionResult result = sut.CreateMusicGenre();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMusicGenre_WhenCalled_ReturnsViewResult()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMusicGenre_WhenCalled_ReturnsViewResultWhereViewNameIsNotNull()
        {
            Controller sut = CreateSut();

            ViewResult result = (ViewResult)sut.CreateMusicGenre();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMusicGenre_WhenCalled_ReturnsViewResultWhereViewNameIsNotEmpty()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMusicGenre_WhenCalled_ReturnsViewResultWhereViewNameIsEqualToCreateGenericCategory()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMusicGenre_WhenCalled_ReturnsViewResultWhereModelIsNotNull()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateMusicGenre_WhenCalled_ReturnsViewResultWhereModelIsGenericCategoryViewModel()
        {
            Controller sut = CreateSut();
            ...
            Assert.That(genericCategoryViewModel.Header, Is.EqualTo("Opret musikgenre"));
            ...
            Assert.That(genericCategoryViewModel.SubmitAction, Is.EqualTo("CreateMusicGenre"));
