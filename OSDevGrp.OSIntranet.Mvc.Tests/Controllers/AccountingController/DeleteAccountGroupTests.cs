...
namespace OSDevGrp.OSIntranet.Mvc.Tests.Controllers.AccountingController
{
    ...
    public class DeleteAccountGroupTests
    {
        ...
        public async Task DeleteAccountGroup_WhenCalledWithNumber_AssertPublishAsyncWasCalledOnCommandBus()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync<IDeleteAccountGroupCommand>(It.Is<IDeleteAccountGroupCommand>(value => value.Number == number)), Times.Once);
        }
        ...
        [Test]
        [Category("UnitTest")]
        public async Task DeleteAccountGroup_WhenCalledWithNumber_ReturnsRedirectToActionResultWhereContollerNameIsEqualToAccounting()
        {
            Controller sut = CreateSut();
