...
{
    [TestFixture]
    public class StartCreatingAccountTests
    {
        ...
        [Test]
        [Category("UnitTest")]
        public void StartCreatingAccount_WhenCalled_ReturnsPartialViewResultWhereModelIsAccountingIdentificationViewModelWithAccountingNumberEqualToArgument()
        {
            Controller sut = CreateSut();

            int accountingNumber = _fixture.Create<int>();
            PartialViewResult result = (PartialViewResult) sut.StartCreatingAccount(accountingNumber);
