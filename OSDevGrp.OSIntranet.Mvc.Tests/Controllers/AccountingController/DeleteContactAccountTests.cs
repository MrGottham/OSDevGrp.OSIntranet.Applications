...
{
    [TestFixture]
    public class DeleteContactAccountTests
    {
        ...
        [Test]
        [Category("UnitTest")]
        public void DeleteContactAccount_WhenAccountNumberIsNull_ThrowsArgumentNullException()
        {
            Controller sut = CreateSut();

            ArgumentNullException result = Assert.ThrowsAsync<ArgumentNullException>(async () => await sut.DeleteContactAccount(_fixture.Create<int>(), null));
        ...
        [Test]
        [Category("UnitTest")]
        public void DeleteContactAccount_WhenAccountNumberIsEmpty_ThrowsArgumentNullException()
        {
            Controller sut = CreateSut();

            ArgumentNullException result = Assert.ThrowsAsync<ArgumentNullException>(async () => await sut.DeleteContactAccount(_fixture.Create<int>(), string.Empty));
        ...
        [Test]
        [Category("UnitTest")]
        public async Task DeleteContactAccount_WhenCalled_ReturnsRedirectToActionResultWhereControllerNameIsNotNull()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public async Task DeleteContactAccount_WhenCalled_ReturnsRedirectToActionResultWhereControllerNameIsEqualToAccounting()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public async Task DeleteContactAccount_WhenCalled_ReturnsRedirectToActionResultWhereActionNameIsNotNull()
        {
            Controller sut = CreateSut();
        ...
        {
            _commandBusMock.Setup(m => m.PublishAsync(It.IsAny<IDeleteContactAccountCommand>()))
