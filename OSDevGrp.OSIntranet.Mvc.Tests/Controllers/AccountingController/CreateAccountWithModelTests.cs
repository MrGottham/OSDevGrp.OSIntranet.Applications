...
{
    [TestFixture]
    public class CreateAccountWithModelTests
    {
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateAccount_WhenAccountViewModelIsNull_ThrowsArgumentNullException()
        {
            Controller sut = CreateSut();

            ArgumentNullException result = Assert.ThrowsAsync<ArgumentNullException>(async () => await sut.CreateAccount(null));
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateAccount_WhenAccountViewModelIsInvalid_ThrowsIntranetSystemExceptionWhereErrorCodeIsEqualToInternalError()
        {
            Controller sut = CreateSut(false);

            IntranetSystemException result = Assert.ThrowsAsync<IntranetSystemException>(async () => await sut.CreateAccount(CreateAccountViewModel()));
        ...
        [Test]
        [Category("UnitTest")]
        public void CreateAccount_WhenAccountViewModelIsInvalid_ThrowsIntranetSystemExceptionWhereInnerExceptionIsNull()
        {
            Controller sut = CreateSut(false);
        ...
        public async Task CreateAccount_WhenAccountViewModelIsValid_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandContainingAccountingNumberFromAccountViewModel()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && command.AccountingNumber == accountingNumber)), Times.Once);
        }
        ...
        public async Task CreateAccount_WhenAccountViewModelIsValid_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandContainingAccountNumberFromAccountViewModel()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && string.CompareOrdinal(command.AccountNumber, accountNumber.ToUpper()) == 0)), Times.Once);
        }

        [Test]
        [Category("UnitTest")]
        public async Task CreateAccount_WhenAccountViewModelIsValid_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandContainingAccountNameFromAccountViewModel()
        {
            Controller sut = CreateSut();
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && string.CompareOrdinal(command.AccountName, accountName) == 0)), Times.Once);
        }

        [Test]
        [Category("UnitTest")]
        public async Task CreateAccount_WhenAccountViewModelIsValidWithoutDescription_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandWhereDescriptionIsEqualToNull()
        {
            Controller sut = CreateSut();
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && command.Description == null)), Times.Once);
            // ReSharper restore MergeIntoPattern
        }

        [Test]
        [Category("UnitTest")]
        public async Task CreateAccount_WhenAccountViewModelIsValidWithDescription_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandContainingDescriptionFromAccountViewModel()
        {
            Controller sut = CreateSut();
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && string.CompareOrdinal(command.Description, description) == 0)), Times.Once);
        }
        ...
        public async Task CreateAccount_WhenAccountViewModelIsValidWithoutNote_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandWhereNoteIsEqualToNull()
        {
            ...
            // ReSharper disable MergeIntoPattern
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && command.Note == null)), Times.Once);
            // ReSharper restore MergeIntoPattern
        }
        ...
        public async Task CreateAccount_WhenAccountViewModelIsValidWithNote_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandContainingNoteFromAccountViewModel()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && string.CompareOrdinal(command.Note, note) == 0)), Times.Once);
        }

        [Test]
        [Category("UnitTest")]
        public async Task CreateAccount_WhenAccountViewModelIsValid_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandContainingAccountGroupNumberFromAccountViewModel()
        {
            Controller sut = CreateSut();
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && command.AccountGroupNumber == accountGroupNumber)), Times.Once);
        }
        ...
        public async Task CreateAccount_WhenAccountViewModelIsValid_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandContainingCreditInfoCollectionNotEqualToNull()
        {
            ...
            // ReSharper disable MergeIntoPattern
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && command.CreditInfoCollection != null)), Times.Once);
            // ReSharper restore MergeIntoPattern
        }
        ...
        public async Task CreateAccount_WhenAccountViewModelIsValidWithCreditInfosOnlyContainingDataForLastYear_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandContainingEmptyCreditInfoCollection()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && command.CreditInfoCollection.Any() == false)), Times.Once);
        }
        ...
        public async Task CreateAccount_WhenAccountViewModelIsValidWithCreditInfosOnlyContainingDataForYearToDate_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandContainingCreditInfoCollectionWithCreditInfoForCurrentMonth()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && command.CreditInfoCollection.All(creditInfo => creditInfo.Year == (short) DateTime.Today.Year && creditInfo.Month == (short) DateTime.Today.Month))), Times.Once);
        }
        ...
        public async Task CreateAccount_WhenAccountViewModelIsValidWithCreditInfosOnlyContainingDataForNext11Months_AssertPublishAsyncWasCalledOnCommandBusWithCreateAccountCommandContainingCreditInfoCollectionWithCreditInfoForNext11Months()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<ICreateAccountCommand>(command => command != null && command.CreditInfoCollection.All(creditInfo => creditInfoViewModelCollection.SingleOrDefault(creditInfoViewModel => creditInfoViewModel.Year == creditInfo.Year && creditInfoViewModel.Month == creditInfo.Month) != null))), Times.Once);
        }

        [Test]
        [Category("UnitTest")]
        public async Task CreateAccount_WhenAccountViewModelIsValid_ReturnsNotNull()
        {
            Controller sut = CreateSut();

            AccountViewModel accountViewModel = CreateAccountViewModel();

            IActionResult result = await sut.CreateAccount(accountViewModel);
        ...
        [Test]
        [Category("UnitTest")]
        public async Task CreateAccount_WhenAccountViewModelIsValid_ReturnsRedirectToActionResult()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public async Task CreateAccount_WhenAccountViewModelIsValid_ReturnsRedirectToActionResultWhereControllerNameIsNotNull()
        {
            Controller sut = CreateSut();

            AccountViewModel accountViewModel = CreateAccountViewModel();

            RedirectToActionResult result = (RedirectToActionResult) await sut.CreateAccount(accountViewModel);
        ...
        [Test]
        [Category("UnitTest")]
        public async Task CreateAccount_WhenAccountViewModelIsValid_ReturnsRedirectToActionResultWhereControllerNameIsEqualToAccounting()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public async Task CreateAccount_WhenAccountViewModelIsValid_ReturnsRedirectToActionResultWhereActionNameIsNotNull()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public async Task CreateAccount_WhenAccountViewModelIsValid_ReturnsRedirectToActionResultWhereActionNameIsEqualToAccountings()
        {
            Controller sut = CreateSut();
        ...
        {
            _commandBusMock.Setup(m => m.PublishAsync(It.IsAny<ICreateAccountCommand>()))
