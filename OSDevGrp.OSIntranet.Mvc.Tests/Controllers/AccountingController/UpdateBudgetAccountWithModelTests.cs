...
{
    [TestFixture]
    public class UpdateBudgetAccountWithModelTests
    {
        ...
        [Test]
        [Category("UnitTest")]
        public void UpdateBudgetAccount_WhenBudgetAccountViewModelIsNull_ThrowsArgumentNullException()
        {
            Controller sut = CreateSut();

            ArgumentNullException result = Assert.ThrowsAsync<ArgumentNullException>(async () => await sut.UpdateBudgetAccount(null));
        ...
        public void UpdateBudgetAccount_WhenBudgetAccountViewModelIsInvalid_ThrowsIntranetSystemExceptionWhereErrorCodeIsEqualToInternalError()
        {
            ...
            IntranetSystemException result = Assert.ThrowsAsync<IntranetSystemException>(async () => await sut.UpdateBudgetAccount(CreateBudgetAccountViewModel()));
        ...
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValid_AssertPublishAsyncWasCalledOnCommandBusWithUpdateBudgetAccountCommandContainingAccountingNumberFromBudgetAccountViewModel()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<IUpdateBudgetAccountCommand>(command => command != null && command.AccountingNumber == accountingNumber)), Times.Once);
        }
        ...
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValid_AssertPublishAsyncWasCalledOnCommandBusWithUpdateBudgetAccountCommandContainingAccountNumberFromBudgetAccountViewModel()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<IUpdateBudgetAccountCommand>(command => command != null && string.CompareOrdinal(command.AccountNumber, accountNumber.ToUpper()) == 0)), Times.Once);
        }

        [Test]
        [Category("UnitTest")]
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValid_AssertPublishAsyncWasCalledOnCommandBusWithUpdateBudgetAccountCommandContainingAccountNameFromBudgetAccountViewModel()
        {
            Controller sut = CreateSut();
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<IUpdateBudgetAccountCommand>(command => command != null && string.CompareOrdinal(command.AccountName, accountName) == 0)), Times.Once);
        }

        [Test]
        [Category("UnitTest")]
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValidWithoutDescription_AssertPublishAsyncWasCalledOnCommandBusWithUpdateBudgetAccountCommandWhereDescriptionIsEqualToNull()
        {
            Controller sut = CreateSut();
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<IUpdateBudgetAccountCommand>(command => command != null && command.Description == null)), Times.Once);
        ...
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValidWithoutNote_AssertPublishAsyncWasCalledOnCommandBusWithUpdateBudgetAccountCommandWhereNoteIsEqualToNull()
        {
            ...
            // ReSharper disable MergeIntoPattern
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<IUpdateBudgetAccountCommand>(command => command != null && command.Note == null)), Times.Once);
            // ReSharper restore MergeIntoPattern
        }
        ...
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValidWithNote_AssertPublishAsyncWasCalledOnCommandBusWithUpdateBudgetAccountCommandContainingNoteFromBudgetAccountViewModel()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<IUpdateBudgetAccountCommand>(command => command != null && string.CompareOrdinal(command.Note, note) == 0)), Times.Once);
        }
        ...
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValid_AssertPublishAsyncWasCalledOnCommandBusWithUpdateBudgetAccountCommandContainingBudgetInfoCollectionNotEqualToNull()
        {
            ...
            // ReSharper disable MergeIntoPattern
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<IUpdateBudgetAccountCommand>(command => command != null && command.BudgetInfoCollection != null)), Times.Once);
            // ReSharper restore MergeIntoPattern
        }
        ...
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValidWithBudgetInfosOnlyContainingDataForYearToDate_AssertPublishAsyncWasCalledOnCommandBusWithUpdateBudgetAccountCommandContainingBudgetInfoCollectionWithOneBudgetInfo()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<IUpdateBudgetAccountCommand>(command => command != null && command.BudgetInfoCollection.Count() == 1)), Times.Once);
        }
        ...
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValidWithBudgetInfosOnlyContainingDataForYearToDate_AssertPublishAsyncWasCalledOnCommandBusWithUpdateBudgetAccountCommandContainingBudgetInfoCollectionWithBudgetInfoForCurrentMonth()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<IUpdateBudgetAccountCommand>(command => command != null && command.BudgetInfoCollection.All(budgetInfo => budgetInfo.Year == (short)DateTime.Today.Year && budgetInfo.Month == (short)DateTime.Today.Month))), Times.Once);
        }
        ...
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValidWithBudgetInfosOnlyContainingDataForNext11Months_AssertPublishAsyncWasCalledOnCommandBusWithUpdateBudgetAccountCommandContainingBudgetInfoCollectionWithBudgetInfoForNext11Months()
        {
            ...
            _commandBusMock.Verify(m => m.PublishAsync(It.Is<IUpdateBudgetAccountCommand>(command => command != null && command.BudgetInfoCollection.All(budgetInfo => budgetInfoViewModelCollection.SingleOrDefault(budgetInfoViewModel => budgetInfoViewModel.Year == budgetInfo.Year && budgetInfoViewModel.Month == budgetInfo.Month) != null))), Times.Once);
        }

        [Test]
        [Category("UnitTest")]
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValid_ReturnsNotNull()
        {
            Controller sut = CreateSut();

            BudgetAccountViewModel budgetAccountViewModel = CreateBudgetAccountViewModel();

            IActionResult result = await sut.UpdateBudgetAccount(budgetAccountViewModel);
        ...
        [Test]
        [Category("UnitTest")]
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValid_ReturnsRedirectToActionResultWhereControllerNameIsNotNull()
        {
            Controller sut = CreateSut();

            BudgetAccountViewModel budgetAccountViewModel = CreateBudgetAccountViewModel();

            RedirectToActionResult result = (RedirectToActionResult) await sut.UpdateBudgetAccount(budgetAccountViewModel);
        ...
        [Test]
        [Category("UnitTest")]
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValid_ReturnsRedirectToActionResultWhereControllerNameIsEqualToAccounting()
        {
            Controller sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public async Task UpdateBudgetAccount_WhenBudgetAccountViewModelIsValid_ReturnsRedirectToActionResultWhereActionNameIsNotNull()
        {
            Controller sut = CreateSut();
        ...
        {
            _commandBusMock.Setup(m => m.PublishAsync(It.IsAny<IUpdateBudgetAccountCommand>()))
