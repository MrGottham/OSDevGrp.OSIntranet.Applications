...
namespace OSDevGrp.OSIntranet.Mvc.Tests.Helpers.Resolvers.PrincipalResolver
{
    [TestFixture]
    public class GetCurrentPrincipalTests
    {
        ...
        private IPrincipalResolver CreateSut(ClaimsPrincipal claimsPrincipal = null)
        {
            ...
            return new Mvc.Helpers.Resolvers.PrincipalResolver(_httpContextAccessorMock.Object);
        }
    }
}