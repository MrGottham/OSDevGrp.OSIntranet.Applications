...
{
    public abstract class KeyValueEntryIdentificationCommandHandlerBase<T> : CommandHandlerTransactionalBase, ICommandHandler<T> where T : IKeyValueEntryIdentificationCommand
    {
        #region Constructor
