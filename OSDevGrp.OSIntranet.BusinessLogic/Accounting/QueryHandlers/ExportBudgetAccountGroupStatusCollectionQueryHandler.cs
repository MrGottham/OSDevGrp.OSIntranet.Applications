...
namespace OSDevGrp.OSIntranet.BusinessLogic.Accounting.QueryHandlers
{
    internal class ExportBudgetAccountGroupStatusCollectionQueryHandler : ExportDomainCollectionFromAccountingToCsvQueryHandlerBase<IExportBudgetAccountGroupStatusCollectionQuery, IBudgetAccountGroupStatus, IBudgetAccountGroupStatusToCsvConverter>
    {
        ...
        public ExportBudgetAccountGroupStatusCollectionQueryHandler(IValidator validator, IClaimResolver claimResolver, IAccountingRepository accountingRepository, IStatusDateSetter statusDateSetter, IBudgetAccountGroupStatusToCsvConverter domainObjectToCsvConverter) 
