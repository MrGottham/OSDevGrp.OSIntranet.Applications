...
namespace OSDevGrp.OSIntranet.BusinessLogic.Accounting.QueryHandlers
{
    internal class ExportContactAccountCollectionQueryHandler : ExportDomainCollectionFromAccountingToCsvQueryHandlerBase<IExportContactAccountCollectionQuery, IContactAccount, IContactAccountToCsvConverter>
    {
        ...
        public ExportContactAccountCollectionQueryHandler(IValidator validator, IClaimResolver claimResolver, IAccountingRepository accountingRepository, IStatusDateSetter statusDateSetter, IContactAccountToCsvConverter domainObjectToCsvConverter) 
