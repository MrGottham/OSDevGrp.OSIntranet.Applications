...
namespace OSDevGrp.OSIntranet.BusinessLogic.Accounting.QueryHandlers
{
    internal class ExportBudgetAccountCollectionQueryHandler : ExportDomainCollectionFromAccountingToCsvQueryHandlerBase<IExportBudgetAccountCollectionQuery, IBudgetAccount, IBudgetAccountToCsvConverter>
    {
        ...
        public ExportBudgetAccountCollectionQueryHandler(IValidator validator, IAccountingRepository accountingRepository, IStatusDateSetter statusDateSetter, IBudgetAccountToCsvConverter domainObjectToCsvConverter) 
