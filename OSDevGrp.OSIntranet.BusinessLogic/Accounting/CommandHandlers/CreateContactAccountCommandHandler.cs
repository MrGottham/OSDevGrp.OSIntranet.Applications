...
{
    public class CreateContactAccountCommandHandler : AccountIdentificationCommandHandlerBase<ICreateContactAccountCommand>
    {
        #region Constructor

        public CreateContactAccountCommandHandler(IValidator validator, IAccountingRepository accountingRepository, ICommonRepository commonRepository) 
