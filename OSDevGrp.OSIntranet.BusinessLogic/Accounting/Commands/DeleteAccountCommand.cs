...
{
    public class DeleteAccountCommand : AccountIdentificationCommandBase, IDeleteAccountCommand
    {
        #region Methods
        ...
        public override IValidator Validate(IValidator validator, IAccountingRepository accountingRepository, ICommonRepository commonRepository)
        {
            ...
            return base.Validate(validator, accountingRepository, commonRepository)
                ...
                .Object.ShouldBeDeletable(AccountNumber, accountNumber => GetAccountAsync(accountingRepository), GetType(), nameof(AccountNumber));
        }
