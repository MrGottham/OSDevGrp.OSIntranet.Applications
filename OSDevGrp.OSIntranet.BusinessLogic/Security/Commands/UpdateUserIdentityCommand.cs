...
{
    public class UpdateUserIdentityCommand : UserIdentityCommandBase, IUpdateUserIdentityCommand
    {
        #region Methods
        ...
        public override IValidator Validate(IValidator validator, ISecurityRepository securityRepository)
        {
            ...
            return base.Validate(validator, securityRepository)
                .Object.ShouldBeKnownValue(Identifier, number => Task.Run(async () => await GetUserIdentityAsync(securityRepository) != null), GetType(), nameof(Identifier));
        }
