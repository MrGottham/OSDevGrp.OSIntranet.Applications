...
{
	internal class CreateBookGenreCommand : CreateGenericCategoryCommandBase<IBookGenre>, ICreateBookGenreCommand
	{
		#region Constructor

		public CreateBookGenreCommand(int number, string name) 
			: base(number, name)
		{
		}
