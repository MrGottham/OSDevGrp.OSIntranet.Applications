...
{
	internal sealed class DeleteMovieCommand : MovieIdentificationCommandBase, IDeleteMovieCommand
	{
		#region Constructor

		public DeleteMovieCommand(Guid mediaIdentifier) 
		...
		public override IValidator Validate(IValidator validator, IClaimResolver claimResolver, IMediaLibraryRepository mediaLibraryRepository, ICommonRepository commonRepository)
		{
			...
			return base.Validate(validator, claimResolver, mediaLibraryRepository, commonRepository)
				.Object.ShouldBeDeletable(MediaIdentifier, mediaLibraryRepository.GetMediaAsync<IMovie>, GetType(), nameof(MediaIdentifier));
		}
