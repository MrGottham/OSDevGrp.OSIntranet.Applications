...
{
	internal sealed class DeleteMusicCommand : MusicIdentificationCommandBase, IDeleteMusicCommand
	{
		#region Constructor

		public DeleteMusicCommand(Guid mediaIdentifier) 
		...
		public override IValidator Validate(IValidator validator, IClaimResolver claimResolver, IMediaLibraryRepository mediaLibraryRepository, ICommonRepository commonRepository)
		{
			...
			return base.Validate(validator, claimResolver, mediaLibraryRepository, commonRepository)
				.Object.ShouldBeDeletable(MediaIdentifier, mediaLibraryRepository.GetMediaAsync<IMusic>, GetType(), nameof(MediaIdentifier));
		}
