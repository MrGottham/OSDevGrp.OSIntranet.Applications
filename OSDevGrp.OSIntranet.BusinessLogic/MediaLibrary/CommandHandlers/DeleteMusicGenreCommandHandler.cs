...
{
	internal class DeleteMusicGenreCommandHandler : DeleteGenericCategoryCommandHandlerBase<IDeleteMusicGenreCommand, IMusicGenre>
	{
		...
		public DeleteMusicGenreCommandHandler(IValidator validator, IClaimResolver claimResolver, IMediaLibraryRepository mediaLibraryRepository)
			: base(validator)
		{
		...
		protected override Task ManageRepositoryAsync(int number) => _mediaLibraryRepository.DeleteMusicGenreAsync(number);
