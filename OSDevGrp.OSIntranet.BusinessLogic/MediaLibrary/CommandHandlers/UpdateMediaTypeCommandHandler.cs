...
{
	internal class UpdateMediaTypeCommandHandler : UpdateGenericCategoryCommandHandlerBase<IUpdateMediaTypeCommand, IMediaType>
	{
		...
		public UpdateMediaTypeCommandHandler(IValidator validator, IClaimResolver claimResolver, IMediaLibraryRepository mediaLibraryRepository)
			: base(validator)
		{
		...
		protected override Task ManageRepositoryAsync(IMediaType mediaType)
		{
			...
			return _mediaLibraryRepository.UpdateMediaTypeAsync(mediaType);
		}
