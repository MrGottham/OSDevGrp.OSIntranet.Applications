...
{
	internal class CreateMovieGenreCommandHandler : CreateGenericCategoryCommandHandlerBase<ICreateMovieGenreCommand, IMovieGenre>
	{
		...
		public CreateMovieGenreCommandHandler(IValidator validator, IClaimResolver claimResolver, IMediaLibraryRepository mediaLibraryRepository)
			: base(validator)
		{
		...
		protected override Task ManageRepositoryAsync(IMovieGenre movieGenre)
		{
			...
			return _mediaLibraryRepository.CreateMovieGenreAsync(movieGenre);
		}
