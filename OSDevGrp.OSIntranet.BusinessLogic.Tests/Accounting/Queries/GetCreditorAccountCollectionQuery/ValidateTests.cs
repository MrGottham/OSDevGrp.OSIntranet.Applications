...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Queries.GetCreditorAccountCollectionQuery
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IGetCreditorAccountCollectionQuery sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidator()
        {
            ...
            IGetCreditorAccountCollectionQuery sut = CreateSut(accountingNumber);
        ...
        private IGetCreditorAccountCollectionQuery CreateSut(int? accountingNumber = null)
        {
            _claimResolverMock.Setup(m => m.CanAccessAccounting(It.IsAny<int>()))
                .Returns(_fixture.Create<bool>());

            return _fixture.Build<BusinessLogic.Accounting.Queries.GetCreditorAccountCollectionQuery>()
