...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Queries.GetAccountCollectionQuery
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        private IGetAccountCollectionQuery CreateSut(int? accountingNumber = null)
        {
            _claimResolverMock.Setup(m => m.CanAccessAccounting(It.IsAny<int>()))
                .Returns(_fixture.Create<bool>());

            return _fixture.Build<BusinessLogic.Accounting.Queries.GetAccountCollectionQuery>()
