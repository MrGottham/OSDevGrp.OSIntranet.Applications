...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Queries.AccountGroupIdentificationQueryBase
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IAccountGroupIdentificationQuery sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeBetweenWasCalledOnIntegerValidator()
        {
            ...
            IAccountGroupIdentificationQuery sut = CreateSut(number);
        ...
        private IAccountGroupIdentificationQuery CreateSut(int? number = null)
        {
        ...
        private class Sut : BusinessLogic.Accounting.Queries.AccountGroupIdentificationQueryBase
        {
        }
    }
}