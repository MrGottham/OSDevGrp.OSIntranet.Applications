...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Queries.GetContactAccountCollectionQuery
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IGetContactAccountCollectionQuery sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidator()
        {
            ...
            IGetContactAccountCollectionQuery sut = CreateSut(accountingNumber);
        ...
        private IGetContactAccountCollectionQuery CreateSut(int? accountingNumber = null)
        {
            _claimResolverMock.Setup(m => m.CanAccessAccounting(It.IsAny<int>()))
                .Returns(_fixture.Create<bool>());

            return _fixture.Build<BusinessLogic.Accounting.Queries.GetContactAccountCollectionQuery> ()
