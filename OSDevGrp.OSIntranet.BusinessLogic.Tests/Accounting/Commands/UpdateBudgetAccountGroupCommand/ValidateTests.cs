...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Commands.UpdateBudgetAccountGroupCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IUpdateBudgetAccountGroupCommand sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidator()
        {
            ...
            IUpdateBudgetAccountGroupCommand sut = CreateSut(number);
        ...
        private IUpdateBudgetAccountGroupCommand CreateSut(int? number = null)
        {
            return _fixture.Build<BusinessLogic.Accounting.Commands.UpdateBudgetAccountGroupCommand>()
