...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Commands.CreateBudgetAccountGroupCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            ICreateBudgetAccountGroupCommand sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeUnknownValueWasCalledOnObjectValidator()
        {
            ...
            ICreateBudgetAccountGroupCommand sut = CreateSut(number);
        ...
        private ICreateBudgetAccountGroupCommand CreateSut(int? number = null)
        {
            _claimResolverMock.Setup(m => m.IsAccountingAdministrator())
                .Returns(_fixture.Create<bool>());

            return _fixture.Build<BusinessLogic.Accounting.Commands.CreateBudgetAccountGroupCommand>()
