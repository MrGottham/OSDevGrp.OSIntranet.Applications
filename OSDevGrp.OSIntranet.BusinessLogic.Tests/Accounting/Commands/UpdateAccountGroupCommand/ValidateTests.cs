...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Commands.UpdateAccountGroupCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        private IUpdateAccountGroupCommand CreateSut(int? number = null)
        {
            _claimResolverMock.Setup(m => m.IsAccountingAdministrator())
                .Returns(_fixture.Create<bool>());

            return _fixture.Build<BusinessLogic.Accounting.Commands.UpdateAccountGroupCommand>()
