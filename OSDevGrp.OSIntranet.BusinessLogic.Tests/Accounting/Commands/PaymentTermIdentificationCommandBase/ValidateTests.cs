...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Commands.PaymentTermIdentificationCommandBase
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IPaymentTermIdentificationCommand sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void Validate_WhenCalled_Validate_WhenCalled_AssertHasNecessaryPermissionWasCalledOnPermissionValidator()
        {
            bool isAccountingAdministrator = _fixture.Create<bool>();
            IPaymentTermIdentificationCommand sut = CreateSut(isAccountingAdministrator);
        ...
        public void Validate_WhenCalled_AssertShouldBeBetweenWasCalledOnIntegerValidator()
        {
            ...
            IPaymentTermIdentificationCommand sut = CreateSut(number: number);
        ...
        private IPaymentTermIdentificationCommand CreateSut(bool? isAccountingAdministrator = null, int? number = null)
        {
        ...
        private class Sut : BusinessLogic.Accounting.Commands.PaymentTermIdentificationCommandBase
        {
        }
    }
}