...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Commands.DeleteAccountGroupCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IDeleteAccountGroupCommand sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidator()
        {
            ...
            IDeleteAccountGroupCommand sut = CreateSut(number);
        ...
        public void Validate_WhenCalled_AssertShouldBeDeletableWasCalledOnObjectValidator()
        {
            ...
            _validatorMockContext.ObjectValidatorMock.Verify(m => m.ShouldBeDeletable(
                    It.Is<int>(value => value == number),
                    It.IsNotNull<Func<int, Task<IAccountGroup>>>(),
                    It.Is<Type>(type => type == sut.GetType()),
                    It.Is<string>(field => string.Compare(field, "Number", false) == 0),
                    It.Is<bool>(allowNull => allowNull == false)),
                Times.Once());
        ...
        private IDeleteAccountGroupCommand CreateSut(int? number = null)
        {
            return _fixture.Build<BusinessLogic.Accounting.Commands.DeleteAccountGroupCommand>()
