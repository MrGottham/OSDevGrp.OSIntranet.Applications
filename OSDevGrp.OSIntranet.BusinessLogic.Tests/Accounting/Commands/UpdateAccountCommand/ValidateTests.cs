...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Commands.UpdateAccountCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IUpdateAccountCommand sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidatorWithAccountNumber()
        {
            ...
            IUpdateAccountCommand sut = CreateSut(accountNumber);
        ...
        private IUpdateAccountCommand CreateSut(string accountNumber = null)
        {
            ...
            return _fixture.Build<BusinessLogic.Accounting.Commands.UpdateAccountCommand>()
