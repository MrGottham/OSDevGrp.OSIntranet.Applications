...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.Commands.DeleteAccountingCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        private IDeleteAccountingCommand CreateSut(int? accountingNumber = null)
        {
            return _fixture.Build<BusinessLogic.Accounting.Commands.DeleteAccountingCommand>()
