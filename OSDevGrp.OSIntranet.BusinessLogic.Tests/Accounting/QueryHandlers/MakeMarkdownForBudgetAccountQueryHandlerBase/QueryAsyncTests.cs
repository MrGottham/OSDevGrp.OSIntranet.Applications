...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Accounting.QueryHandlers.MakeMarkdownForBudgetAccountQueryHandlerBase
{
    ...
    public class QueryAsyncTests
    {
        ...
        private IQueryHandler<IExportFromAccountQuery, byte[]> CreateSut(bool hasBudgetAccount = true, IBudgetAccount budgetAccount = null, bool hasMarkdownContent = true, string markdownContent = null)
        {
            ...
            return new MyMakeMarkdownForBudgetAccountQueryHandler(_validatorMock.Object, _claimResolverMock.Object, _accountingRepositoryMock.Object, _statusDateSetterMock.Object, _budgetAccountToMarkdownConverterMock.Object, false);
        }
        ...
        private class MyMakeMarkdownForBudgetAccountQueryHandler : MakeMarkdownForBudgetAccountQueryHandlerBase<IExportFromAccountQuery, IAccountToMarkdownConverter<IBudgetAccount>>
        {
            ...
            public MyMakeMarkdownForBudgetAccountQueryHandler(IValidator validator, IClaimResolver claimResolver, IAccountingRepository accountingRepository, IStatusDateSetter statusDateSetter, IAccountToMarkdownConverter<IBudgetAccount> budgetAccountToMarkdownConverter, bool encoderShouldEmitUtf8Identifier = true)
