...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Contacts.Queries.ContactGroupIdentificationQueryBase
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IContactGroupIdentificationQuery sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeBetweenWasCalledOnIntegerValidator()
        {
            ...
            IContactGroupIdentificationQuery sut = CreateSut(number);
        ...
        private IContactGroupIdentificationQuery CreateSut(int? number = null)
        {
        ...
        private class Sut : BusinessLogic.Contacts.Queries.ContactGroupIdentificationQueryBase
        {
        }
    }
}
