...
using CommandHandler=OSDevGrp.OSIntranet.BusinessLogic.Contacts.CommandHandlers.UpdateCountryCommandHandler;

namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Contacts.CommandHandlers.UpdateCountryCommandHandler
{
    [TestFixture]
    public class ExecuteAsyncTests
    {
        ...
        public async Task ExecuteAsync_WhenCalled_AssertToDomainWasCalledOnCommand()
        {
            ...
            Mock<IUpdateCountryCommand> commandMock = CreateCommandMock();
        ...
        {
            _contactRepositoryMock.Setup(m => m.UpdateCountryAsync(It.IsAny<ICountry>()))
        ...
        private Mock<IUpdateCountryCommand> CreateCommandMock(ICountry country = null)
        {
            Mock<IUpdateCountryCommand> commandMock = new Mock<IUpdateCountryCommand>();
