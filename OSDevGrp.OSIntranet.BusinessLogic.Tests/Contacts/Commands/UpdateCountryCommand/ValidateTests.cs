...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Contacts.Commands.UpdateCountryCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        private IUpdateCountryCommand CreateSut(string countryCode = null)
        {
            return _fixture.Build<BusinessLogic.Contacts.Commands.UpdateCountryCommand>()
