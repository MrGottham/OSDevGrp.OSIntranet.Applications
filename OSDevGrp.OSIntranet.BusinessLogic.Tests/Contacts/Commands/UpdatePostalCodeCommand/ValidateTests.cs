...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Contacts.Commands.UpdatePostalCodeCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IUpdatePostalCodeCommand sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidator()
        {
            ...
            IUpdatePostalCodeCommand sut = CreateSut(postalCode);
        ...
        private IUpdatePostalCodeCommand CreateSut(string postalCode = null)
        {
            return _fixture.Build<BusinessLogic.Contacts.Commands.UpdatePostalCodeCommand>()
