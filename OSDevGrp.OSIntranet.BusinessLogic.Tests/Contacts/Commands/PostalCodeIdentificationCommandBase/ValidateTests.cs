...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Contacts.Commands.PostalCodeIdentificationCommandBase
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IPostalCodeIdentificationCommand sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldNotBeNullOrWhiteSpaceWasCalledOnStringValidator()
        {
            ...
            IPostalCodeIdentificationCommand sut = CreateSut(postalCode);
        ...
        private IPostalCodeIdentificationCommand CreateSut(string postalCode = null)
        {
        ...
        private class Sut : BusinessLogic.Contacts.Commands.PostalCodeIdentificationCommandBase
        {
        }
    }
}
