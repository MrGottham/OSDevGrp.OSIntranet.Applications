...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Contacts.Commands.CreateContactCommand
{
    [TestFixture]
    public class ToDomainTests
    {
        ...
        private ICreateContactCommand CreateSut()
        {
            ...
            return _fixture.Build<BusinessLogic.Contacts.Commands.CreateContactCommand>()
