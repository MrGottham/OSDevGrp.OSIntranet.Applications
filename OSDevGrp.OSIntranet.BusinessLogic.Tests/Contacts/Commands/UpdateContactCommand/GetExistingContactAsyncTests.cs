...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Contacts.Commands.UpdateContactCommand
{
    ...
    public class GetExistingContactAsyncTests
    {
        ...
        public void SetUp()
        {
            ...
            _fixture.Customize<INameCommand>(builder => builder.FromFactory(() => new Mock<INameCommand>().Object));
            _fixture.Customize<IAddressCommand>(builder => builder.FromFactory(() => new Mock<IAddressCommand>().Object));
            _fixture.Customize<ICompanyNameCommand>(builder => builder.FromFactory(() => new Mock<ICompanyNameCommand>().Object));
            _fixture.Customize<ICompanyCommand>(builder => builder.FromFactory(() => new Mock<ICompanyCommand>().Object));
        }
        ...
        public async Task GetExistingContactAsync_WhenCalled_AssertGetContactAsyncWasCalledOnMicrosoftGraphRepository()
        {
            ...
            IUpdateContactCommand sut = CreateSut(tokenType, accessToken, expires, refreshToken, externalIdentifier);
