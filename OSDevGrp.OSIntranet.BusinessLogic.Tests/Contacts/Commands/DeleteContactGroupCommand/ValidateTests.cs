...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Contacts.Commands.DeleteContactGroupCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IDeleteContactGroupCommand sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidator()
        {
            ...
            IDeleteContactGroupCommand sut = CreateSut(number);
        ...
        public void Validate_WhenCalled_AssertShouldBeDeletableWasCalledOnObjectValidator()
        {
            ...
            _validatorMockContext.ObjectValidatorMock.Verify(m => m.ShouldBeDeletable(
                    It.Is<int>(value => value == number),
                    It.IsNotNull<Func<int, Task<IContactGroup>>>(),
                    It.Is<Type>(type => type == sut.GetType()),
                    It.Is<string>(field => string.CompareOrdinal(field, "Number") == 0),
                    It.Is<bool>(value => value == false)),
                Times.Once());
        ...
        private IDeleteContactGroupCommand CreateSut(int? number = null)
        {
            return _fixture.Build<BusinessLogic.Contacts.Commands.DeleteContactGroupCommand>()
