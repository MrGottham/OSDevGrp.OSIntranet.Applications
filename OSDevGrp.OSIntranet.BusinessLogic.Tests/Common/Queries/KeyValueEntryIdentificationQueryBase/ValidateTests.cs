...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Common.Queries.KeyValueEntryIdentificationQueryBase
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IKeyValueEntryIdentificationQuery sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldNotBeNullOrWhiteSpaceWasCalledOnStringValidatorWithKey()
        {
            ...
            IKeyValueEntryIdentificationQuery sut = CreateSut(key);
        ...
        private IKeyValueEntryIdentificationQuery CreateSut(string key = null)
        {
        ...
        private class Sut : BusinessLogic.Common.Queries.KeyValueEntryIdentificationQueryBase
        {
        }
    }
}