...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Common.Queries.LetterHeadIdentificationQueryBase
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            ILetterHeadIdentificationQuery sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeBetweenWasCalledOnIntegerValidator()
        {
            ...
            ILetterHeadIdentificationQuery sut = CreateSut(number);
        ...
        private ILetterHeadIdentificationQuery CreateSut(int? number = null)
        {
        ...
        private class Sut : BusinessLogic.Common.Queries.LetterHeadIdentificationQueryBase
        {
        }
    }
}