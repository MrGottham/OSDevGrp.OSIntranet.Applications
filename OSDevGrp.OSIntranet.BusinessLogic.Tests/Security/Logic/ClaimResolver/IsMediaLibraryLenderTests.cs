...
{
	[TestFixture]
	public class IsMediaLibraryLenderTests
	{
		...
		[Test]
		[Category("UnitTest")]
		public void IsMediaLibraryLender_WhenCalled_AssertGetCurrentPrincipalWasCalledOnPrincipalResolver()
		{
			IClaimResolver sut = CreateSut();

			sut.IsMediaLibraryLender();
		...
		[Test]
		[Category("UnitTest")]
		public void IsMediaLibraryLender_WhenCalledAndPrincipalDoesNotHaveMediaLibraryLenderClaim_ReturnsFalse()
		{
			...
			bool result = sut.IsMediaLibraryLender();
		...
		[Test]
		[Category("UnitTest")]
		public void IsMediaLibraryLender_WhenCalledAndPrincipalHasMediaLibraryLenderClaim_ReturnsTrue()
		{
			IPrincipal principal = CreateClaimsPrincipal(new[] { new Claim(_fixture.Create<string>(), _fixture.Create<string>()), ClaimHelper.CreateMediaLibraryLenderClaim() });
			IClaimResolver sut = CreateSut(principal);
