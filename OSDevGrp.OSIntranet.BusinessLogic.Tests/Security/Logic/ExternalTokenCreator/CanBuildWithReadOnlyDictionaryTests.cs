...
{
	[TestFixture]
	public class CanBuildWithReadOnlyDictionaryTests : ExternalTokenCreatorTestBase
	{
		...
		public void CanBuild_WhenAuthenticationSessionItemsDoesNotContainKeyForTokenType_ReturnsFalse(bool hasAccessToken, bool hasRefreshToken, bool hasExpiresAt, bool hasExpiresIn)
		{
			...
			IReadOnlyDictionary<string, string> authenticationSessionItems = CreateAuthenticationSessionItems(_fixture, _random, hasTokenType: false, hasAccessToken: hasAccessToken, hasRefreshToken: hasRefreshToken, hasExpiresAt: hasExpiresAt, hasExpiresIn: hasExpiresIn).AsReadOnly();
		...
		public void CanBuild_WhenAuthenticationSessionItemsDoesNotContainKeyForAccessToken_ReturnsFalse(bool hasTokenType, bool hasRefreshToken, bool hasExpiresAt, bool hasExpiresIn)
		{
			...
			IReadOnlyDictionary<string, string> authenticationSessionItems = CreateAuthenticationSessionItems(_fixture, _random, hasTokenType: hasTokenType, hasAccessToken: false, hasRefreshToken: hasRefreshToken, hasExpiresAt: hasExpiresAt, hasExpiresIn: hasExpiresIn).AsReadOnly();
			bool result = sut.CanBuild(authenticationSessionItems);
		...
		public void CanBuild_WhenAuthenticationSessionItemsDoesNotContainKeyForExpiresAtAndNoKeyForExpiresIn_ReturnsFalse(bool hasTokenType, bool hasAccessToken, bool hasRefreshToken)
		{
			...
			IReadOnlyDictionary<string, string> authenticationSessionItems = CreateAuthenticationSessionItems(_fixture, _random, hasTokenType: hasTokenType, hasAccessToken: hasAccessToken, hasRefreshToken: hasRefreshToken, hasExpiresAt: false, hasExpiresIn: false).AsReadOnly();
			bool result = sut.CanBuild(authenticationSessionItems);
		...
		public void CanBuild_WhenAuthenticationSessionItemsContainsNecessaryKeysToBuildExternalToken_ReturnsTrue(bool hasRefreshToken, bool hasExpiresAt, bool hasExpiresIn)
		{
			...
			IReadOnlyDictionary<string, string> authenticationSessionItems = CreateAuthenticationSessionItems(_fixture, _random, hasTokenType: true, hasAccessToken: true, hasRefreshToken: hasRefreshToken, hasExpiresAt: hasExpiresAt, hasExpiresIn: hasExpiresIn).AsReadOnly();
			bool result = sut.CanBuild(authenticationSessionItems);
