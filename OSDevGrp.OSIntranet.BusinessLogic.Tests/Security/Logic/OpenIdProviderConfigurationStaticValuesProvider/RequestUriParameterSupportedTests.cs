...
{
    [TestFixture]
    public class RequestUriParameterSupportedTests : OpenIdProviderConfigurationStaticValuesProviderTestBase
    {
        ...
        [Test]
        [Category("UnitTest")]
        public void RequestUriParameterSupported_WhenCalled_ReturnsFalse()
        {
            IOpenIdProviderConfigurationStaticValuesProvider sut = CreateSut();

            bool result = sut.RequestUriParameterSupported;
