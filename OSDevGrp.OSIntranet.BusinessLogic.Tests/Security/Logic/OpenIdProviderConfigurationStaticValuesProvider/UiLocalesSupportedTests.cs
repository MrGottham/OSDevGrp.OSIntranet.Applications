...
{
    [TestFixture]
    public class UiLocalesSupportedTests : OpenIdProviderConfigurationStaticValuesProviderTestBase
    {
        ...
        [Test]
        [Category("UnitTest")]
        public void UiLocalesSupported_WhenCalled_ReturnsNotNull()
        {
            IOpenIdProviderConfigurationStaticValuesProvider sut = CreateSut();

            IReadOnlyCollection<string> result = sut.UiLocalesSupported;
        ...
        [Test]
        [Category("UnitTest")]
        public void UiLocalesSupported_WhenCalled_ReturnsNotEmpty()
        {
            IOpenIdProviderConfigurationStaticValuesProvider sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void UiLocalesSupported_WhenCalled_ReturnsCollectionContainingOneSupportedClaimsLocale()
        {
            IOpenIdProviderConfigurationStaticValuesProvider sut = CreateSut();
        ...
        [Test]
        [Category("UnitTest")]
        public void UiLocalesSupported_WhenCalled_ReturnsCollectionContainingEnUsAsSupportedClaimsLocale()
        {
            IOpenIdProviderConfigurationStaticValuesProvider sut = CreateSut();
