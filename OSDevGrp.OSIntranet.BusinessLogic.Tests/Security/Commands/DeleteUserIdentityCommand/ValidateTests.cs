...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Security.Commands.DeleteUserIdentityCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IDeleteUserIdentityCommand sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidator()
        {
            ...
            IDeleteUserIdentityCommand sut = CreateSut(identifier);
        ...
        private IDeleteUserIdentityCommand CreateSut(int? identifier = null)
        {
            return _fixture.Build<OSDevGrp.OSIntranet.BusinessLogic.Security.Commands.DeleteUserIdentityCommand>()
