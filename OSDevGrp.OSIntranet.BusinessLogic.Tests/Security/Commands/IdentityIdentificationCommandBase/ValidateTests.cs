...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Security.Commands.IdentityIdentificationCommandBase
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IIdentityIdentificationCommand sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeGreaterThanZeroWasCalledOnIntegerValidator()
        {
            ...
            IIdentityIdentificationCommand sut = CreateSut(identifier);
        ...
        private IIdentityIdentificationCommand CreateSut(int? identifier = null)
        {
        ...
        private class Sut : OSDevGrp.OSIntranet.BusinessLogic.Security.Commands.IdentityIdentificationCommandBase
        {
        }
    }
}