...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Security.Commands.DeleteClientSecretIdentityCommand
{
    [TestFixture]
    public class ValidateTests
    {
        ...
        {
            IDeleteClientSecretIdentityCommand sut = CreateSut();
        ...
        public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidator()
        {
            ...
            IDeleteClientSecretIdentityCommand sut = CreateSut(identifier);
        ...
        private IDeleteClientSecretIdentityCommand CreateSut(int? identifier = null)
        {
            return _fixture.Build<OSDevGrp.OSIntranet.BusinessLogic.Security.Commands.DeleteClientSecretIdentityCommand>()
