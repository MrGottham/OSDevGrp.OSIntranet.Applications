...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Security.Commands.UpdateClientSecretIdentityCommand
{
    ...
    public class ValidateTests
    {
        ...
        public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidator()
        {
            ...
            IUpdateClientSecretIdentityCommand sut = CreateSut(identifier);
        ...
        {
            return _fixture.Build<OSDevGrp.OSIntranet.BusinessLogic.Security.Commands.UpdateClientSecretIdentityCommand>()
