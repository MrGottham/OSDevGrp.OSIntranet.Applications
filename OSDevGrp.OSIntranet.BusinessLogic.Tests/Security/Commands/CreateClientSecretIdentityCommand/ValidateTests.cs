...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Security.Commands.CreateClientSecretIdentityCommand
{
    ...
    public class ValidateTests
    {
        ...
        public void Validate_WhenCalled_AssertShouldBeUnknownValueWasCalledOnObjectValidator()
        {
            ...
            ICreateClientSecretIdentityCommand sut = CreateSut(identifier);
        ...
        {
            return _fixture.Build<OSDevGrp.OSIntranet.BusinessLogic.Security.Commands.CreateClientSecretIdentityCommand>()
