...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.Security.Commands.CreateUserIdentityCommand
{
    ...
    public class ValidateTests
    {
        ...
        public void Validate_WhenCalled_AssertShouldBeUnknownValueWasCalledOnObjectValidator()
        {
            ...
            ICreateUserIdentityCommand sut = CreateSut(identifier);
        ...
        {
            return _fixture.Build<OSDevGrp.OSIntranet.BusinessLogic.Security.Commands.CreateUserIdentityCommand>()
