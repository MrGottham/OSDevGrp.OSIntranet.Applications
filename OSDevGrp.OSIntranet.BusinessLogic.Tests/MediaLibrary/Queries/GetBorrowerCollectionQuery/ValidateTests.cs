...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.MediaLibrary.Queries.GetBorrowerCollectionQuery
{
	[TestFixture]
	public class ValidateTests
	{
		...
		{
			IGetBorrowerCollectionQuery sut = CreateSut();
		...
		{
			IGetBorrowerCollectionQuery sut = CreateSut(filter);
		...
		private IGetBorrowerCollectionQuery CreateSut(string filter = null)
		{
			return new BusinessLogic.MediaLibrary.Queries.GetBorrowerCollectionQuery(filter);
		}
	}
}