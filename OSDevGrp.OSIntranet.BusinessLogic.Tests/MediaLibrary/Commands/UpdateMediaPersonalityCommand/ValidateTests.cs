...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.MediaLibrary.Commands.UpdateMediaPersonalityCommand
{
	...
	public class ValidateTests
	{
		...
		private IUpdateMediaPersonalityCommand CreateSut(Guid? mediaPersonalityIdentifier = null)
		{
			...
			return MediaLibraryCommandFactory.BuildUpdateMediaPersonalityCommand(mediaPersonalityIdentifier ?? Guid.NewGuid(), _random.Next(100) > 50 ? _fixture.Create<string>() : null, _random.Next(100) > 50 ? _fixture.Create<string>() : null, _fixture.Create<string>(), _fixture.Create<int>(), _random.Next(100) > 50 ? DateTime.Today.AddDays(_random.Next(1, 365) * -1) : null, _random.Next(100) > 50 ? DateTime.Today.AddDays(_random.Next(1, 365) * -1) : null, _random.Next(100) > 50 ? $"https://localhost/api/mediaPersonality/{_fixture.Create<string>()}" : null, _random.Next(100) > 50 ? _fixture.CreateMany<byte>(_random.Next(1024, 4096)).ToArray() : Array.Empty<byte>());
		}
	}
}