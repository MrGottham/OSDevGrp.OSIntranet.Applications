...
namespace OSDevGrp.OSIntranet.BusinessLogic.Tests.MediaLibrary.Commands.UpdateMovieCommand
{
    [TestFixture]
	public class ValidateTests
	{
		...
		{
			IUpdateMovieCommand sut = CreateSut();
		...
		public void Validate_WhenCalled_AssertShouldBeKnownValueWasCalledOnObjectValidatorWithMediaIdentifier()
		{
			...
			IUpdateMovieCommand sut = CreateSut(mediaIdentifier);
