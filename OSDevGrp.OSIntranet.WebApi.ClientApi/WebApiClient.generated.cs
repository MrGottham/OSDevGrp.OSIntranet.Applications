        ...
        public virtual async System.Threading.Tasks.Task<ApplyPostingJournalModel> PostingjournalGETAsync(int accountingNumber, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/Accounting/{accountingNumber}/postingjournal"
                    urlBuilder_.Append("api/Accounting/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(accountingNumber, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/postingjournal");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ApplyPostingJournalModel>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new WebApiClientException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
