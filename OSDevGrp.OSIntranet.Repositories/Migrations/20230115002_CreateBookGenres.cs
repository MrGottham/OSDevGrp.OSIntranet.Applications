...
namespace OSDevGrp.OSIntranet.Repositories.Migrations
{
    ...
    [Migration("20230115002_CreateBookGenres")]
    internal class CreateBookGenres : Migration
    {
        #region Methods
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable("BookGenres",
                table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookGenres", m => m.BookGenreIdentifier);
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("BookGenres");
        }
