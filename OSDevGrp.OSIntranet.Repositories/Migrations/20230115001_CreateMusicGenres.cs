...
namespace OSDevGrp.OSIntranet.Repositories.Migrations
{
    ...
    [Migration("20230115001_CreateMusicGenres")]
    internal class CreateMusicGenres : Migration
    {
        #region Methods
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable("MusicGenres",
                table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicGenres", m => m.MusicGenreIdentifier);
                });
        }
