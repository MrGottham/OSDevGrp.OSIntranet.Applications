...
namespace OSDevGrp.OSIntranet.Bff.DomainServices.Tests.Exceptions.IdentifierAlreadyExistsException;
...
public class ConstructorTests
{
    ...
    public void Constructor_WhenCalledWithIdentifier_StoresIdentifier()
    {
        ...
        // Act
        var sut = new Interfaces.Exceptions.IdentifierAlreadyExistsException(identifier);
    ...
    public void Constructor_WhenCalledWithIdentifier_UsesDefaultMessage()
    {
        ...
        // Assert
        Assert.That(sut.Message, Is.EqualTo("The identifier already exists."));
    }
    ...
    public void Constructor_WhenCalledWithIdentifierAndCustomMessage_StoresCustomMessage()
    {
        ...
        // Act
        var sut = new Interfaces.Exceptions.IdentifierAlreadyExistsException(identifier, customMessage);
