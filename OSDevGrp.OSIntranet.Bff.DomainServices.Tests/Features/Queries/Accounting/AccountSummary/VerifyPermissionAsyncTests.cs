...
public class VerifyPermissionAsyncTests : AccountIdentificationFeatureTestBase
{
    ...
    [Test]
    [Category("UnitTest")]
    public async Task VerifyPermissionAsync_WhenUserIsAuthenticatedAndHasAccountingAccessAndIsAccountingViewer_AssertResultIsTrue()
    {
        IPermissionVerifiable<MyAccountIdentificationRequest> sut = CreateSut(_fixture!, _permissionCheckerMock!, _accountingGatewayMock!, _staticTextProviderMock!, _dynamicTextsBuilderMock!, _validationRuleSetBuilderMock!);
