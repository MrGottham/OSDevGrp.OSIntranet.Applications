...
[TestFixture]
public class WithRequiredValueRuleTests : ValidationRuleSetBuilderTestBase
{
    ...
    [TestCase(StaticTextKey.AccountingNumber)]
    [TestCase(StaticTextKey.AccountingName)]
    public void WithRequiredValueRule_WhenCalled_ReturnsSameValidationRuleSetBuilder(StaticTextKey staticTextKey)
    {
        IValidationRuleSetBuilder sut = CreateSut();

        IValidationRuleSetBuilder result = sut.WithRequiredValueRule(staticTextKey);
