...
public class BuildAsyncTests
{
    ...
    public async Task BuildAsync_WhenCalled_ReturnsValidationRuleSetBuildedByExtendedValidationRuleSetBuilder()
    {
        ...
        IPostingJournalLineIdentifierRuleSetBuilder sut = CreateSut(validationRuleSet: validationRuleSet);
    ...
    private IPostingJournalLineIdentifierRuleSetBuilder CreateSut(IReadOnlyCollection<IValidationRule>? validationRuleSet = null)
    {
        _extendedValidationRuleSetBuilderMock!.Setup(_fixture!, validationRuleSet: validationRuleSet);

        return new DomainServices.Logic.Validation.PostingJournalLineIdentifierRuleSetBuilder(_extendedValidationRuleSetBuilderMock!.Object);
    }
}