...
[TestFixture]
public class WithMaxValueRuleTests : ExtendedValidationRuleSetBuilderTestBase
{
    ...
    public void WithMaxValueRule_WhenCalled_AssertCreateAsyncWasNotCalledOnRequiredValueRuleFactory(StaticTextKey staticTextKey)
    {
        IExtendedValidationRuleSetBuilder sut = CreateSut();

        sut.WithMaxValueRule(staticTextKey, _fixture!.Create<int>());
    ...
    [TestCase(StaticTextKey.AccountingNumber)]
    [TestCase(StaticTextKey.AccountingName)]
    public void WithMaxValueRule_WhenCalled_AssertCreateAsyncWasNotCalledOnMinLengthRuleFactory(StaticTextKey staticTextKey)
    {
        IExtendedValidationRuleSetBuilder sut = CreateSut();
    ...
    [TestCase(StaticTextKey.AccountingNumber)]
    [TestCase(StaticTextKey.AccountingName)]
    public void WithMaxValueRule_WhenCalled_AssertCreateAsyncWasNotCalledOnMaxLengthRuleFactory(StaticTextKey staticTextKey)
    {
        IExtendedValidationRuleSetBuilder sut = CreateSut();
    ...
    [TestCase(StaticTextKey.AccountingNumber)]
    [TestCase(StaticTextKey.AccountingName)]
    public void WithMaxValueRule_WhenCalled_AssertCreateAsyncWasNotCalledOnShouldBeIntegerRuleFactory(StaticTextKey staticTextKey)
    {
        IExtendedValidationRuleSetBuilder sut = CreateSut();
    ...
    [TestCase(StaticTextKey.AccountingNumber)]
    [TestCase(StaticTextKey.AccountingName)]
    public void WithMaxValueRule_WhenCalled_AssertCreateAsyncWasNotCalledOnMinValueRuleFactory(StaticTextKey staticTextKey)
    {
        IExtendedValidationRuleSetBuilder sut = CreateSut();
    ...
    [TestCase(StaticTextKey.AccountingNumber)]
    [TestCase(StaticTextKey.AccountingName)]
    public void WithMaxValueRule_WhenCalled_AssertCreateAsyncWasNotCalledOnMaxValueRuleFactoryMock(StaticTextKey staticTextKey)
    {
        IExtendedValidationRuleSetBuilder sut = CreateSut();
    ...
    [TestCase(StaticTextKey.AccountingNumber)]
    [TestCase(StaticTextKey.AccountingName)]
    public void WithMaxValueRule_WhenCalled_AssertCreateAsyncWasNotCalledOnPatternRuleFactory(StaticTextKey staticTextKey)
    {
        IExtendedValidationRuleSetBuilder sut = CreateSut();
    ...
    [TestCase(StaticTextKey.AccountingNumber)]
    [TestCase(StaticTextKey.AccountingName)]
    public void WithMaxValueRule_WhenCalled_AssertCreateAsyncWasNotCalledOnOneOfRuleFactory(StaticTextKey staticTextKey)
    {
        IExtendedValidationRuleSetBuilder sut = CreateSut();
    ...
    [TestCase(StaticTextKey.AccountingNumber)]
    [TestCase(StaticTextKey.AccountingName)]
    public void WithMaxValueRule_WhenCalled_ReturnsSameExtendedValidationRuleSetBuilder(StaticTextKey staticTextKey)
    {
        IExtendedValidationRuleSetBuilder sut = CreateSut();

        IExtendedValidationRuleSetBuilder result = sut.WithMaxValueRule(staticTextKey, _fixture!.Create<int>());
