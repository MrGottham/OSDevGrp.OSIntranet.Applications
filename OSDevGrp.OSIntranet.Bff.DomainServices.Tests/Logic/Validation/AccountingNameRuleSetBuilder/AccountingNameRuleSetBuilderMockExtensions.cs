...
internal static class AccountingNameRuleSetBuilderMockExtensions
{
    #region Methods

    internal static void Setup(this Mock<IAccountingNameRuleSetBuilder> accountingNameRuleSetBuilderMock, Fixture fixture, IReadOnlyCollection<IValidationRule>? validationRuleSet = null)
    {
        validationRuleSet ??=
        [
        ...
        accountingNameRuleSetBuilderMock.Setup(m => m.BuildAsync(It.IsAny<IFormatProvider>(), It.IsAny<CancellationToken>()))
