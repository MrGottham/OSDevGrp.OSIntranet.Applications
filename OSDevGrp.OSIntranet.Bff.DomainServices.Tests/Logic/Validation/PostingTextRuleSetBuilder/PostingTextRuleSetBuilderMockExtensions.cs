...
internal static class PostingTextRuleSetBuilderMockExtensions
{
    #region Methods

    internal static void Setup(this Mock<IPostingTextRuleSetBuilder> postingTextRuleSetBuilderMock, Fixture fixture, IReadOnlyCollection<IValidationRule>? validationRuleSet = null)
    {
        validationRuleSet ??=
        [
        ...
        postingTextRuleSetBuilderMock.Setup(m => m.BuildAsync(It.IsAny<IFormatProvider>(), It.IsAny<CancellationToken>()))
