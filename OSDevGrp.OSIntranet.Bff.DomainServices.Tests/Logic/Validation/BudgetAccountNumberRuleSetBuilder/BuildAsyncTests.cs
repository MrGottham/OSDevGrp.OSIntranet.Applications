...
public class BuildAsyncTests
{
    ...
    {
        IBudgetAccountNumberRuleSetBuilder sut = CreateSut();
    ...
    [Test]
    [Category("UnitTest")]
    public async Task BuildAsync_WhenCalled_AssertWithMinLengthRuleWasCalledOnExtendedValidationRuleSetBuilderWithStaticTextKeyAndMinLengthForBudgetAccount()
    {
        IBudgetAccountNumberRuleSetBuilder sut = CreateSut();
    ...
    [Test]
    [Category("UnitTest")]
    public async Task BuildAsync_WhenCalled_AssertWithMaxLengthRuleWasCalledOnExtendedValidationRuleSetBuilderWithStaticTextKeyAndMaxLengthForBudgetAccount()
    {
        IBudgetAccountNumberRuleSetBuilder sut = CreateSut();
    ...
    [Test]
    [Category("UnitTest")]
    public async Task BuildAsync_WhenCalled_AssertWithPatternRuleWasCalledOnExtendedValidationRuleSetBuilderWithStaticTextKeyAndPatternForBudgetAccount()
    {
        IBudgetAccountNumberRuleSetBuilder sut = CreateSut();
    ...
    public async Task BuildAsync_WhenCalled_ReturnsValidationRuleSetBuildedByExtendedValidationRuleSetBuilder()
    {
        ...
        IBudgetAccountNumberRuleSetBuilder sut = CreateSut(validationRuleSet: validationRuleSet);
    ...
    private IBudgetAccountNumberRuleSetBuilder CreateSut(IReadOnlyCollection<IValidationRule>? validationRuleSet = null)
    {
        _extendedValidationRuleSetBuilderMock!.Setup(_fixture!, validationRuleSet: validationRuleSet);

        return new DomainServices.Logic.Validation.BudgetAccountNumberRuleSetBuilder(_extendedValidationRuleSetBuilderMock!.Object);
    }
}