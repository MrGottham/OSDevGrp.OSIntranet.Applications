...
internal static class BackDatingRuleSetBuilderMockExtensions
{
    #region Methods

    internal static void Setup(this Mock<IBackDatingRuleSetBuilder> backDatingRuleSetBuilderMock, Fixture fixture, IReadOnlyCollection<IValidationRule>? validationRuleSet = null)
    {
        validationRuleSet ??=
        [
        ...
        backDatingRuleSetBuilderMock.Setup(m => m.BuildAsync(It.IsAny<IFormatProvider>(), It.IsAny<CancellationToken>()))
