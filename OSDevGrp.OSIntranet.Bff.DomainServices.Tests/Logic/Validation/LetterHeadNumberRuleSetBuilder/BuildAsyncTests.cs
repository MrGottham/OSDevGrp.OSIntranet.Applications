...
public class BuildAsyncTests
{
    ...
    [Test]
    [Category("UnitTest")]
    public async Task BuildAsync_WhenCalled_AssertWithRequiredValueRuleWasCalledOnExtendedValidationRuleSetBuilderWithStaticTextKeyForLetterHeadNumber()
    {
        ILetterHeadNumberRuleSetBuilder sut = CreateSut();

        await sut.BuildAsync(CultureInfo.InvariantCulture);

        _extendedValidationRuleSetBuilderMock!.Verify(m => m.WithRequiredValueRule(It.Is<StaticTextKey>(value => value == StaticTextKey.LetterHeadNumber)), Times.Once);
    }

    [Test]
    [Category("UnitTest")]
    public async Task BuildAsync_WhenCalled_AssertWithShouldBeIntegerRuleWasCalledOnExtendedValidationRuleSetBuilderWithStaticTextKeyForLetterHeadNumber()
    {
        ILetterHeadNumberRuleSetBuilder sut = CreateSut();

        await sut.BuildAsync(CultureInfo.InvariantCulture);

        _extendedValidationRuleSetBuilderMock!.Verify(m => m.WithShouldBeIntegerRule(It.Is<StaticTextKey>(value => value == StaticTextKey.LetterHeadNumber)), Times.Once);
    }

    [Test]
    [Category("UnitTest")]
    public async Task BuildAsync_WhenCalled_AssertWithRangeRuleWasCalledOnExtendedValidationRuleSetBuilderWithStaticTextKeyForLetterHeadNumber()
    {
        ILetterHeadNumberRuleSetBuilder sut = CreateSut();
        ...
        _extendedValidationRuleSetBuilderMock!.Verify(m => m.WithRangeRule(
                It.Is<StaticTextKey>(value => value == StaticTextKey.LetterHeadNumber),
                It.IsAny<int>(),
                It.IsAny<int>()),
            Times.Once);
    }
    ...
    [Test]
    [Category("UnitTest")]
    public async Task BuildAsync_WhenCalled_AssertWithRangeRuleWasCalledOnExtendedValidationRuleSetBuilderWithStaticTextKeyAndMinValueForLetterHeadNumber()
    {
        ILetterHeadNumberRuleSetBuilder sut = CreateSut();
        ...
        _extendedValidationRuleSetBuilderMock!.Verify(m => m.WithRangeRule(
                It.Is<StaticTextKey>(value => value == StaticTextKey.LetterHeadNumber),
                It.Is<int>(value => value == LetterHeadRuleSetSpecifications.LetterHeadNumberMinValue),
                It.IsAny<int>()),
            Times.Once);
    }
    ...
    [Test]
    [Category("UnitTest")]
    public async Task BuildAsync_WhenCalled_AssertWithRangeRuleWasCalledOnExtendedValidationRuleSetBuilderWithStaticTextKeyAndMaxValueForLetterHeadNumber()
    {
        ILetterHeadNumberRuleSetBuilder sut = CreateSut();
        ...
        _extendedValidationRuleSetBuilderMock!.Verify(m => m.WithRangeRule(
                It.Is<StaticTextKey>(value => value == StaticTextKey.LetterHeadNumber),
                It.IsAny<int>(),
                It.Is<int>(value => value == LetterHeadRuleSetSpecifications.LetterHeadNumberMaxValue)),
            Times.Once);
    }
    ...
    public async Task BuildAsync_WhenCalled_ReturnsValidationRuleSetBuildedByExtendedValidationRuleSetBuilder()
    {
        ...
        ILetterHeadNumberRuleSetBuilder sut = CreateSut(validationRuleSet: validationRuleSet);
    ...
    private ILetterHeadNumberRuleSetBuilder CreateSut(IReadOnlyCollection<IValidationRule>? validationRuleSet = null)
    {
        _extendedValidationRuleSetBuilderMock!.Setup(_fixture!, validationRuleSet: validationRuleSet);

        return new DomainServices.Logic.Validation.LetterHeadNumberRuleSetBuilder(_extendedValidationRuleSetBuilderMock!.Object);
    }
}