...
public class GetStaticTextAsyncTests
{
    ...
    [TestCase(StaticTextKey.MyOverview, "Mit overblik", 0)]
    ...
    [TestCase(StaticTextKey.AccountDeletionQuestion, "Er du sikker på, at du vil slette kontoen med navnet [AccountName]?", 0)]
    [TestCase(StaticTextKey.BudgetAccountDeletionQuestion, "Er du sikker på, at du vil slette budgetkontoen med navnet [BudgetAccountName]?", 0)]
    [TestCase(StaticTextKey.ContactAccountDeletionQuestion, "Er du sikker på, at du vil slette kontaktkontoen med navnet [ContactAccountName]?", 0)]
    ...
    [TestCase(StaticTextKey.BalanceSheetAtStatusDate, "Balance pr. dags dato", 0)]
    [TestCase(StaticTextKey.BalanceSheetAtEndOfLastMonthFromStatusDate, "Balance ved sidste måneds afslutning", 0)]
    [TestCase(StaticTextKey.BalanceSheetAtEndOfLastYearFromStatusDate, "Balance ved sidste års afslutning", 0)]
    [TestCase(StaticTextKey.Debit, "Debit", 0)]
    [TestCase(StaticTextKey.Credit, "Kredit", 0)]
    [TestCase(StaticTextKey.Balance, "Saldo", 0)]
    [TestCase(StaticTextKey.Assets, "Aktiver", 0)]
    [TestCase(StaticTextKey.AssetsTotal, "Aktiver i alt", 0)]
    [TestCase(StaticTextKey.Liabilities, "Passiver", 0)]
    [TestCase(StaticTextKey.LiabilitiesTotal, "Passiver i alt", 0)]
    [TestCase(StaticTextKey.BudgetStatementForMonthOfStatusDate, "Resultat denne måned", 0)]
    [TestCase(StaticTextKey.BudgetStatementForLastMonthOfStatusDate, "Resultat sidste måned", 0)]
    [TestCase(StaticTextKey.BudgetStatementForYearToDateOfStatusDate, "Resultat år til dato", 0)]
    [TestCase(StaticTextKey.BudgetStatementForLastYearOfStatusDate, "Resultat sidste år", 0)]
    [TestCase(StaticTextKey.Budget, "Budget", 0)]
    [TestCase(StaticTextKey.Posted, "Bogført", 0)]
    [TestCase(StaticTextKey.Result, "Resultat", 0)]
    [TestCase(StaticTextKey.Available, "Disponibel", 0)]
    ...
    [TestCase(StaticTextKey.ContactAccountValuesAtEndOfLastYearFromStatusDate, "Saldooplysninger ved sidste års afslutning", 0)]
    ...
    [TestCase(StaticTextKey.Accounts, "Konti", 0)]
    [TestCase(StaticTextKey.Account, "Konto", 0)]
    [TestCase(StaticTextKey.BudgetAccounts, "Budgetkonti", 0)]
    [TestCase(StaticTextKey.BudgetAccount, "Budgetkonto", 0)]
    [TestCase(StaticTextKey.ContactAccounts, "Kontaktkonti", 0)]
    [TestCase(StaticTextKey.ContactAccount, "Kontaktkonto", 0)]
    [TestCase(StaticTextKey.AccountNumberShort, "Kontonr.", 0)]
    [TestCase(StaticTextKey.AccountName, "Kontonavn", 0)]
    [TestCase(StaticTextKey.Bookkeeping, "Bogføring", 0)]
    [TestCase(StaticTextKey.LatestPostings, "Seneste posteringer", 0)]
    [TestCase(StaticTextKey.PostingDate, "Dato", 0)]
    ...
    [TestCase(StaticTextKey.PostingJournalLineIdentifier, "Identifikation", 0)]
