...
namespace OSDevGrp.OSIntranet.Bff.DomainServices.Tests.Cqs.PipelineExtensions.FeatureLogging.CommandFeatureLogging;
...
public class ExecuteAsyncTests : FeatureLoggingTestBase
{
    ...
    public async Task ExecuteAsync_WhenExceptionWasThrown_AssertLogWasCalledOnLoggerWithError()
    {
        ...
        _innerFeatureMock = CreateFailingCommandFeatureMock(() => exception);
    ...
    {
        return new DomainServices.Cqs.PipelineExtensions.FeatureLogging.CommandFeatureLogging<IRequest>(_innerFeatureMock!.Object, _loggerFactoryMock!.Object);
    }
}